      ...
      <div className="inner">
        ...
        <div className="content">
          ...
          <div className="text-box" ref={textBoxRef}>
            <p>
              저는 Vue 기반의 그룹웨어 프로젝트를 처음부터 끝까지 주도하며,
              실사용자의 피드백을 적극 반영해 사용 만족도를 높인 경험이
              있습니다. 실패를 두려워하지 않고, 어떤 도전도 배움의 기회로 삼아
              끝까지 완수하는 책임감을 가지고 있습니다. 퍼블리셔로서 단순한
              구현을 넘어 기능 이상의 가치를 만들고, 팀에 긍정적인 영향을 주는
              사람이 되고자 늘 노력합니다.
            </p>
            <p>
              사용자 중심의 UI 설계와 체계적인 퍼블리싱, 그리고 원활한
              커뮤니케이션을 통해 문제를 해결하고자 하며, 디자인 시스템 기반의
              피그마 설계부터 웹표준을 준수한 퍼블리싱, 프론트엔드 개발자와의
              유연한 협업까지 고려하며 일합니다. 단순히 ‘디자인을 구현하는
              사람’을 넘어, 사용자의 니즈를 파악하고 기획자, 클라이언트, 개발자
              사이에서 조율하며 더 나은 방향을 함께 고민할 줄 아는 퍼블리셔가
              되고자 합니다 :)
            </p>
          </div>
        </div>
